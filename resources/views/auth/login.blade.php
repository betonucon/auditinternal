...
<body class="pace-top">
	...
	<div id="page-container" class="fade">
		...
		<div class="login login-with-news-feed">
			<!-- begin news-feed -->
			<div class="news-feed">
				<div class="news-image" style="background-image: url({{url_plug()}}/img/logo.jpg)"></div>
				<div class="news-caption">
					<!-- <h4 class="caption-title">ss</h4> -->
					<p>
			...
			<div class="right-content">
				...
				<div class="login-header">
					<div class="brand">
                    <img src="{{url_plug()}}/img/ks.png" width="80%">
				...
				<div class="login-content">
                    <form method="POST" action="{{ route('login') }}" class="margin-bottom-0">
						...
						<div class="form-group m-b-15">
							<input type="text" class="form-control form-control-lg" placeholder="Username"  name="email" value="{{ old('email') }}" required />
                            @if ($errors->has('email'))
                                {{ $errors->first('email') }}
                            @endif
                        </div>
