                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                            {{jumlah_total_temuan(0)}}
                                            </div>
                                        </div>
                                        @foreach(get_status_act(1) as $o)
                                        <div class="form-group row">
                                            <label class="col-lg-6 col-form-label">{{$o->name}}</label>
                                            <div class="col-lg-6">
                                            {{jumlah_total_temuan($o->id)}}
                                            </div>
                                        </div>
                                        @endforeach
                                    </div>
                                    <div class="col-md-6">
                                        @foreach(get_status_act(2) as $oo)
                                        <div class="form-group row">
                                            <label class="col-lg-7 col-form-label">{{$oo->name}}</label>
                                            <div class="col-lg-5">
                                                {{jumlah_total_temuan($oo->id)}}
                                            </div>
                                        </div>
                                        @endforeach
                                    </div>
