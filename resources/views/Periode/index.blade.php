...
<div id="content" class="content">
    ...
    <h1 class="page-header">Data Periode<small></small></h1>
    <div class="row">
        <div class="col-xl-12">
            <!-- begin panel -->
...
@push('ajax')
    <script>
        ...
        function tambah(id){
            location.assign("{{url('Periode/form')}}?id="+id)
        }
        function detail(username,role_id){
            location.assign("{{url('Periode/detail')}}?nik="+username+"&role_id="+role_id)
        }
        function ceklis(id){
            $('#idkey').val(id);
        }
